...
macOS dmg
    ...
    cd build
    xcrun notarytool submit dfvue-6.6-intel.dmg --keychain-profile "notarytool-password"
    xcrun notarytool log 6d0cb58d-867d-4f91-a3e6-98c27c58f3e9 --keychain-profile "notarytool-password" developer_log.json
    xcrun stapler staple dfvue-6.6-intel.dmg
    scp dfvue-6.6-intel.dmg macu.de@ssh.strato.de:extra/
Windows installer
    python cx_freeze_setup.py bdist_msi
    cd dist
    scp dfvue-6.6-win64.msi macu.de@ssh.strato.de:extra/
